...
<Aside type="caution" title="What is NOT reconstructable">
SessionFS cannot reconstruct the exact text of unmanaged project rules, global rules, or nested agent/skill files. You can verify whether a file has changed since a session by comparing hashes, but you cannot display a text diff for these artifact types.
</Aside>
